	...
	<body class="animsition">
		...
		<section class="section-slide p-b-50">
			<div class="wrap-slick1">
				<div class="slick1">
					<div class="item-slick1" style="background-image: url(images/slide_01.jpg)">
					...
					<div class="item-slick1" style="background-image: url(images/slide_02.jpg)">
						<div class="container h-full">
							<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
								...
								<div class="layer-slick1 animated visible-false" data-appear="lightSpeedIn" data-delay="800">
									<h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1">STAY COOL</h2>
								</div>
					...
					<div class="item-slick1" style="background-image: url(images/slide_03.jpg)">
						<div class="container h-full">
							<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
								<div class="layer-slick1 animated visible-false" data-appear="rotateInDownLeft" data-delay="0">
									<span class="ltext-101 cl2 respon2"> Women Collection 2022 </span>
								</div>
