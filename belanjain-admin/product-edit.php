<?php
	...
	$productDetails = http_request("http://localhost/belanjain/api/product/product-details.php?id=$product_id");
...
<html lang="en">
	<head>
		...
		<!-- favicon11 -->
		<link rel="shortcut icon" href="public/img/favicon11.ico" />
